          ...
          <div className="animate-fade-up">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-8">
              <div>
                ...
                <p className="text-primary/70">Master's, Human-Centered Design<br>University of Washington</p>
                <br></br>
                <p className="text-primary/70">Certificate, Web Development<br>University of Washington</p>
                <br></br>
                <p className="text-primary/70">Bachelor's, English<br>Virginia Tech</p>
              </div>
              <div>
